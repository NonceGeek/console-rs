...
const CONTRACTS: [&str; 3] = [
    "hello_world", "sha256_test", "poping",
];
...
pub struct App<'a> {
    ...
    pub contracts: StatefulList<&'a str>,
...
impl<'a> App<'a> {
    pub fn new(title: &'a str, enhanced_graphics: bool) -> App<'a> {
        ...
        App {
            title,
            should_quit: false,
            tabs: TabsState::new(vec!["Console", "Terminal", "WeId-Console","Monitor"]),
            show_chart: true,
            progress: 0.0,
            sparkline: Signal {
                source: rand_signal,
            ...
            contracts: StatefulList::with_items(CONTRACTS.to_vec()),
            signals: Signals {
                sin1: Signal {
                    source: sin_signal,
                    points: sin1_points,
